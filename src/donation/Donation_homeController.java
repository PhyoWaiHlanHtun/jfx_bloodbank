...
public class Donation_homeController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        new SetNode(anchor,"/donation/Donation_home_panel.fxml");
                        ...
                        node1.addEventHandler(MouseEvent.MOUSE_CLICKED, (e)->{
                            switch (node1.getAccessibleText()){
                                case "Home":
                                    ...
                                    break;
                                case "Add_donater":
                                    new SetNode(anchor,"/donation/Add_donater_panel.fxml");
                                    break;
                                case "View_donater":
                                    new SetNode(anchor,"/donation/View_donater_panel.fxml");
                                    break;
                                case "Donate":
                                    new SetNode(anchor,"/donation/Donate_panel.fxml");
                                    break;
                                case "exist":
